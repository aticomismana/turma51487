...
function adicionarTabela(){
  ...
  if(descricao && nota && nota <= 10){
     ...
     cols += '<td> <spam id="nota-' + indice + '">'+ nota +
              ...
              '</td>';
     cols += '<td><button type="button" id="editar-' + indice + '" name="editar" onClick="editarTabela(' + indice + ')" class="btn btn-info">Editar</button></td>';
     cols += '<td><button type="button" name="remover" onClick="removerTabela(' + indice + ')" class="btn btn-danger">Remover</button></td>';
     cols += '<td id="concluir-' + indice + '"><button type="button" name="editar" onClick="concluirEdicao(' + indice + ')" class="btn btn-success">Concluir</button></td>';
     cols += '<td>';
     cols += '</td>';
