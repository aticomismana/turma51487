Problema 3 - Aeroporto    
    ...
    Um avião é representado pelo seu prefixo, pelo nome do seu modelo, pelo  
nome do seu fabricante, pela quantidade de assentos e pela quantidade de  
assentos ocupados. Escreva uma classe que represente um avião e desenvolva um  
...
diretos à partir dele e uma lista de outros aeroportos de onde venham vôos  
para ele.  
...
existe alguma forma de se chegar nele.  

    Para isto, o aeroporto deve verificar se ele possui vôo partindo para o   
aeroporto desejado, e caso não saia, se existe alguma forma de chegar nele à  
partir dos aeroportos de onde sai -public boolean possuiRota  
(Aeroporto aeroporto).  
